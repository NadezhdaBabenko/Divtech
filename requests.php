                ...
                <div class="beta-requests">
                    <div class="beta-requests-actions">
                        <div class="beta-requests-actions__search-sort-row">
                            ...
                            <div class="beta-requests-actions__search-block">
                                <div class="beta-requests-actions__search">
                                    <div class="filter-dropdown beta-requests-actions__search-everywhere">
                                        <div class="filter-dropdown__text">
                                            <div class="filter-dropdown__text-select">Искать: везде</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="beta-requests-actions__search-field">
                                    <div class="input-with-btn">
                                        <input class="input-full" type="text" placeholder="Поиск…">
                            ...
                            <div class="beta-requests-btn-group beta-requests-actions__btns-group">
                    ...
                    <div class="beta-requests__grid beta-requests-grid">
                        <table class="beta-requests-grid__table">
                            ...
                            <tr class="beta-requests-grid__row">
                                ...
                                <td class="beta-requests-grid__cell">
                                    <div class="beta-requests-grid__passenger-block">
                                        <a class="beta-requests-grid__passenger" href="#">Бисмилянов А.Л.</a>
                                    </div>
                                </td>
                                <td class="beta-requests-grid__cell">
                                    <div class="beta-requests-grid__info">
                                        ...
                                        <div class="beta-requests-grid__direction-block">
                                        ...
                                        <div class="beta-requests-grid__total-price beta-requests-grid__total-price--demo">
                                        ...
                                        <div class="beta-requests-grid__details-row">
                                            ...
                                            <div class="booking-details-row">
                                                <div class="booking-details-row__main">
                                                    ...
                                                    <div class="booking-details-row__price">
                                                        <a class="booking-details-row__price-link" href="#">
                                                            520 360 <span class="booking-details-row__currency">₸</span>
                                                        </a>
                                                    </div>
                                                    <div class="booking-details-row__service-name">
                                                        КТЖ
                                ...
                                <td class="beta-requests-grid__cell">
                                    <div class="beta-requests-grid__approved-cell approval-cell">
                                        <div class="approval-cell__in-process-block-demo">
                                            <div class="approval-cell__in-process-demo">
                                                В ПРОЦЕССЕ
                                            </div>
                                        ...
                                        <div class="approval-cell__process-items">
                                            <div class="approval-cell__process-item approval-cell__process-item--yellow">

                                            </div>
                                            <div class="approval-cell__process-item">
                                        ...
                                        <div class="approval-cell__process-time">
                                            12:20:53
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr class="beta-requests-grid__row">
                                ...
                                <td class="beta-requests-grid__cell">
                                    <div class="beta-requests-grid__passenger-block">
                                        ...
                                        <a class="beta-requests-grid__passenger" href="#">Плотников С.В.</a>
                                    </div>
                                </td>
                                <td class="beta-requests-grid__cell">
                                    <div class="beta-requests-grid__info">
                                ...
                                <td class="beta-requests-grid__cell">
                                    <div class="beta-requests-grid__approved-cell approval-cell">
                                        <div class="approval-cell__text-demo">
                                            УТВЕРЖДЕНО!
                                        </div>
                                        <div class="approval-cell__status-block-demo">
                                            ...
                                            <div class="approval-cell__status-text-block">
                                                <div class="approval-cell__status-text-demo">
                                                    Алколеев А.Н.
                                                </div>
                            ...
                            <tr class="beta-requests-grid__row">
                                ...
                                <td class="beta-requests-grid__cell">
                                    <button class="btn-blue beta-requests-grid__for-approval">
                                        На утвержение
                                    </button>
                                </td>
                            ...
                            <tr class="beta-requests-grid__row">
                                ...
                                <td class="beta-requests-grid__cell">
                                    <div class="beta-requests-grid__approved-cell approval-cell">
                                        <div class="approval-cell__text-demo approval-cell__text-demo--red">
                                            ОТКЛОНЕНО!
                                        </div>
