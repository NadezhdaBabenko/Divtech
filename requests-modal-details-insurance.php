        ...
        <div class="modal-frame">
            ...
            <div class="modal-frame__table">
                <div class="modal-details">
                    <div class="modal-details__title-row">
                        <div class="modal-details__title">
                            Страхование
                        </div>
                        <div class="modal-details__insurance">
                            Страховой полис № <span class="modal-details__insurance-num">12345-67</span>
                        </div>
                    </div>
                    ...
                    <div class="modal-details__service-type">
                        однократная
                    </div>
