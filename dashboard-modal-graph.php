<?php include "./_inc/header.php" ?>
    ...
    <div class="modal-window-page">
        <div class="dashboard-modal-graph modal-window-page__dashboard-modal">
                    ...
                    <div class="dashboard-modal-graph__sort">
                        <div class="radio-buttons dashboard-modal-graph__radio-buttons radio-buttons--blue">
                            <div class="radio-buttons__blocks">
                                <input class="radio-buttons__input" type="radio" name="option-graph-table" id="radio-graph" checked />
                                <label class="radio-buttons__label" for="radio-graph">Графиком</label>
                            </div>
                            <div class="radio-buttons__blocks">
                                <input class="radio-buttons__input" type="radio" name="option-graph-table" id="radio-table" />
            ...
            <div class="dashboard-modal-graph__graph"> 

            </div>

            <button class="dashboard-modal-graph__btn-graph">
                Показать все
                <svg class="dashboard-modal-graph__btn-svg-graph">
